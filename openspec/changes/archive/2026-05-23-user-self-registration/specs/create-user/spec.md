...
- **THEN** o sistema SHALL inserir uma nova row com `id = jwtData.sub`, `email = jwtData.email`, `role = 'consultor'` e os campos do body, e retornar HTTP 201 com o objeto do usuário criado
